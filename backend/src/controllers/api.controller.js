...
export const getDashboardHealthController = async (req, res) => {
...
export const registerBatchController = async (req, res) => {
   try {
...
export const tokenizeBatchController = async (req, res) => { 
   try {
...
export const verifyBatchController = async (req, res) => { 
  try {
