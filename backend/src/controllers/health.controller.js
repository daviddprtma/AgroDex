...
export const pingHealthController = async (req, res) => {
  res.json({
    ok: true,
...
export const databaseHealthController = async (req, res) => { 
   const out = {
      ok: false,
      env: {
...
export const fullSystemHealthController = async (req, res) => { 
   const checks = {};
